...
Работа проходила на NVIDIA 1060 MaxQ. Для квадратных матриц размера меньше 256 результаты плохо различимы, поэтому они не попали в выборку. Для квадаратных матриц размера 20000+ не удалось подобрать валидный.
